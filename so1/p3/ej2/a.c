...
void tomar_tenedores(int i)
{
    ...
    pthread_mutex_lock(izq(i)); // Se puede dar el caso en el que estén tomados absolutamente todos los cubiertos derechos pero ninguno pueda acceder al izquierdo. DEADLOCK
}
